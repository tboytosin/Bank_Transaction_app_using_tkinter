...
class Front:
    ...
    def login(self):
        ...
        ttk.Label(self.frame_header, text='Welcome to Tiptop Bank!').grid(
    ...
    def home(self):
        ...
        if self.profile_photo:
            ...
            self.newpython = Image.PhotoImage(image)
    ...
    def transaction_history_friend(self, value):
        ...
        if self.friend_obj:
            ...
            image = image.resize((80, 80))
            self.friend_image = Image.PhotoImage(image)
